...
class Interceptor extends \Magento\GiftWrappingGraphQl\Model\Resolver\Cart\Item\GiftWrapping implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\GiftWrapping\Api\WrappingRepositoryInterface $giftWrappingRepository, \Magento\Framework\GraphQl\Query\Uid $uidEncoder)
    {
        $this->___init();
        parent::__construct($giftWrappingRepository, $uidEncoder);
    }
